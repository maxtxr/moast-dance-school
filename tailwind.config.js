...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'serif': ['"TAN Buster"', 'Georgia', 'serif'],
        'sans': ['"Futura"', '"Trebuchet MS"', 'sans-serif'],
      },
      fontSize: {
        'display-hero': ['clamp(2.5rem, 10vw, 7rem)', { lineHeight: '1.1', letterSpacing: '0.02em' }],
        'display-section': ['clamp(2rem, 8vw, 6rem)', { lineHeight: '1.1', letterSpacing: '0.02em' }],
        'display-badge': ['clamp(1.5rem, 5vw, 3.5rem)', { lineHeight: '1.1', letterSpacing: '0.02em' }],
        'display-card': ['clamp(1.125rem, 4vw, 2.25rem)', { lineHeight: '1.1', letterSpacing: '0.02em' }],
      },
      backgroundImage: {
